...
MONO_API void* mono_valloc     (void *addr, size_t length, int flags, const char *what, MonoMemAccountType type);
MONO_API void* mono_valloc_aligned (size_t length, size_t alignment, int flags, const char *what, MonoMemAccountType type);
