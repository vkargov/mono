...
mono_arch_init (void)
{
	...
	ss_trigger_page = mono_valloc (NULL, mono_pagesize (), "ss-trigger-page", MONO_MMAP_READ);
	bp_trigger_page = mono_valloc (NULL, mono_pagesize (), "bp-trigger-page", MONO_MMAP_READ);
