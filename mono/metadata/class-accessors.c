...
mono_class_set_ref_info_handle (MonoClass *class, guint32 value)
{
	...
	Uint32Property *prop = mono_class_alloc (class, sizeof (Uint32Property), "class:properties");
...
{
	PointerProperty *prop = mono_class_alloc (klass, sizeof (PointerProperty), "class:properties");
