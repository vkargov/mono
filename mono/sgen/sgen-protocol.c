...
binary_protocol_get_buffer (int length)
{
 ...
 retry:
	...
	new_buffer = (BinaryProtocolBuffer *)sgen_alloc_os_memory (sizeof (BinaryProtocolBuffer), (SgenAllocFlags)(SGEN_ALLOC_INTERNAL | SGEN_ALLOC_ACTIVATE), "sgen:debugging memory", MONO_MEM_ACCOUNT_SGEN_BINARY_PROTOCOL);
